...
export const user = createSlice({
	...
	reducers: {
		...
		//   store.project.createdProjects.push(newProjectInfo);
		// },
	},
});
...
export const createNewProject = (
	...
	return (dispatch, getStore) => {
		...
		console.log("in thunk create project", creator);
		console.log(projectName, projectShortDescription, projectLongDescription);
		fetch("http://localhost:8080/projects", {
			...
			.then((json) => {
				console.log("I then i createnew thunk", json.projectId);
				dispatch(user.actions.setLastCreatedProjectId(json.projectId));
				//dispatch(getUserProjects());
				console.log(json);
				//	browserHistory.push(`/project/${json.projectId}`);
